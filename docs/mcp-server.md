...
1. **Attention** — vector search finds seed notes, k-hop graph traversal spreads activation, adaptive threshold (`median + 0.3*std` with floor + min-activation guarantee) filters noise
